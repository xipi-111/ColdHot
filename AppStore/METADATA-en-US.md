# ColdHot Mac App Store Metadata

## Product Page

- Name: ColdHot
- Subtitle: Native Mac performance monitor
- Support URL: `https://xipiapp.com/en/coldhot/#support`
- Marketing URL: `https://xipiapp.com/en/coldhot/`
- Privacy Policy URL: `https://xipiapp.com/en/coldhot/#privacy`
- Copyright: 2026 Jianxi Yang
...
ColdHot has no account, advertising, or analytics SDK, and it never uploads monitoring results to the developer or third parties. Metric choices and interface preferences stay on your Mac.

The Mac App Store edition runs in App Sandbox and uses capabilities permitted for this edition. Features that depend on private sensors or system preference changes are available only in the direct edition.

Requires macOS 14 or later.

### Keywords

performance,monitor,menu bar,CPU,GPU,memory,disk,network,battery,thermal,system,status
